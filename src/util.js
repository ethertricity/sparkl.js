...
(function(global) {
  ...
  sparkl.util = {};
  sparkl.util.foldl = foldl;
  sparkl.util.mix = mix;
  sparkl.util.mirror = mirror;
  sparkl.util.environment = environment;
  sparkl.util.Counter = Counter;
  sparkl.util.IdGenerator = IdGenerator;

  if (global.sparkl.util.environment() === "nodejs") {
